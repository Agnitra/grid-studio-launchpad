...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Grid Studio — Digital Agency Elite" },
      { property: "og:description", content: "We build scalable digital experiences engineered for clarity, speed, and growth." },
